...
<p align="center">
   <a href="https://github.com/ISC-HEI/isc-hei-typst-templates/blob/0.8.1/examples/bachelor_thesis.pdf?raw=true"><img src="bachelor_thesis_thumb.png" alt="Preview of the ISC bachelor thesis template title page" height="300"></a>
</p>
